...
for user in user_dict:
    rlevel[user] = [1.0 for i in range(29)]
print (len(rlevel))
print (df["id"][0])
...
rlevel, n_in_list_9, n_out_list_9, n_zero_list_9 = read_gps_within_month("09", user_dict, night_hour, rlevel, threshold)


# In[14]:


out = {"rlevel":rlevel, "in": n_in_list_9, "out": n_out_list_9, "zero": n_zero_list_9}
...
with open(output_path + "feature_9_mean.json", "w") as outfile:
